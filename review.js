...
console.log(`The soluton is: ${varTwo}`)
...
let strStartsWith = 'per scholas'
strStartsWith.startsWith('per')
// Now use any variable with endsWith() and return false
strStartsWith.endsWith('potato')
...
let findTheWordCowInTheGivenString = joshHadALittleLambOopsCow.indexOf("cow")
...
const findWordInString = 'Vanessa'
let found = paragraph.lastIndexOf(findWordInString)

// Can we use length for strings? I don't know, you tell me.
const noWeCantTeo = "but did you try it out though?"
let teoStringLength = noWeCantTeo.length
